...
项目已经完成并合并第 1～29 课。第 30 课已在课程分支通过验收：将正交投影切换为透视投影，把物体放到相机前方，并通过距离实验验证透视除法；当前等待提交并合并。
...
前二十九课均已完成并合并回 `main`。第三十课已在 `codex/lesson-30-perspective-projection` 完成验收，等待提交、推送并合并；当前稳定的 `main` 仍停留在第二十九课。
