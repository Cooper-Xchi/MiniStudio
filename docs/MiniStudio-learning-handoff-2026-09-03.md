...
当前处于：**第 6 周第 24 课已完成验收，课程分支等待提交、推送并合并。**
...
| 第 6 周 | 外部图片数据链路 | 第 21～23 课已合并；第 24 课已验收、等待合并 |
