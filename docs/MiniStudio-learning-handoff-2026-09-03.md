...
当前处于：**第 1～38 课均已完成、验收并合并；第 39 课「索引立方体与面独立 UV」已完成并通过验收，等待学习者确认提交、推送并合并。下一课为第 40 课「几何、状态与资源架构复盘」，尚未启动。**
...
| 第 10～13 周 | 绕序与剔除、立方体、交互相机、透明基础及 v0.2 | 第 37～38 课已合并；第 39 课已验收、待提交合并；第 40～52 课待执行 |
