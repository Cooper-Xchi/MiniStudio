...
当前处于：**第 4 周第 14 课已完成并合并，等待开始第 15 课。**
...
| 第 4 周 | 最小 RAII 封装、Debug/Release、故障定位、README 与生命周期说明 | 进行中；第 14 课已完成并合并，等待第 15 课 |
